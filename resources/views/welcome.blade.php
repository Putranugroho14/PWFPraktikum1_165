...
<body class="bg-black text-white antialiased min-h-screen flex flex-col items-center justify-center p-6">
    <header class="fixed top-0 right-0 p-6 text-sm flex items-center space-x-6">
        @if (Route::has('login'))
                ...
                @else
                    ...
                    @if (Route::has('register'))
                        <a href="{{ route('register') }}"
                            class="px-6 py-2 border border-gray-600 rounded-md text-gray-300 hover:text-white hover:border-gray-400 transition">
                            Register
                        </a>
                    @endif
                @endauth
    ...
    <main class="w-full max-w-sm">
        <div class="bg-[#111] border border-gray-800 rounded-xl p-10 shadow-2xl">
            <h1 class="text-xl font-semibold mb-1">Putra Nugroho</h1>
            <p class="text-gray-400 mb-6 font-mono text-sm tracking-tight">NIM : 20230140165</p>

            <a href="https://github.com/code-worker-me/PWF-Genap-2025/blob/main/pertemuan-1.md" target="_blank"
                class="inline-block w-full text-center bg-white text-black py-3 rounded-md font-medium hover:bg-gray-200 transition">
                Modul Pertemuan 1
            </a>
        </div>
    </main>
